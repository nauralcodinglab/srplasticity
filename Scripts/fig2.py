...
if __name__ == '__main__':
    ...
    figure_modelsteps.savefig(parent_dir + '/Figures/Fig2_modelsteps.pdf')
    plt.close('all')

    figure_gaussians = plot_gaussians()
    figure_gaussians.savefig(parent_dir + '/Figures/Fig2_gaussians.pdf')
    plt.close('all')

    figure_modelres = plot_modelres()
    figure_modelres.savefig(parent_dir + '/Figures/Fig2_modelres.pdf')
    plt.close('all')

    figure_data = plot_data()
    figure_data.savefig(parent_dir + '/Figures/Fig2_data.pdf')
    plt.close('all')
