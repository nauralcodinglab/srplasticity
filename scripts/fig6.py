...
def plot_kernels(axes1):
    axes1[0].plot(
        append(-t[::-1], t), append(k1 * 0 + b, k1 * a + b), "k", color=c_25ca
    )
...
def plot_mu_sig(axes2):
    ...
    axes2[0].plot(
        range(1, 6),
        mean_om1[where(wspktr1 > 0)[0]] / munorm1,
        "s-k",
        ms=3,
        lw=1,
        color=c_25ca,
    ...
    axes2[0].plot(
        range(1, 6),
        mean_om2[where(wspktr2 > 0)[0]] / munorm1,
        "s-r",
        ms=3,
        lw=1,
        color=c_13ca,
    ...
    axes2[1].plot(
        range(1, 6),
        sig2[where(wspktr2 > 0)[0]] / munorm1,
        "s-r",
        ms=3,
        lw=1,
        color=c_13ca,
